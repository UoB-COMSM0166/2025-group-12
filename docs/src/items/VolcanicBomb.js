export class VolcanicBomb extends Enemy {
    ...
    hit(p5, playBoard) {
        ...
        if (cell.plant !== null && baseType(cell.plant) === plantTypes.TREE) {
            InteractionLogic.plantIsAttacked(playBoard, cell.plant, 1);
            return;
        }
        ...
        if (cell.plant !== null || cell.seed !== null) {
            ...
            if (cwt.length !== 0) {
                InteractionLogic.plantIsAttacked(playBoard, cwt[Math.floor(Math.random() * cwt.length)].plant, 1);
                return;
            }
            ...
            if (cell.seed !== null) {
                InteractionLogic.plantIsAttacked(playBoard, cell.seed, 1);
                return;
            }
        }
