...
import {movableTypes, terrainTypes} from "../../items/ItemTypes.js";
...
export class Volcano1PlayBoard extends PlayBoard {
    ...
    generateLava(p5, i, j) {
        ...
        if (cell.enemy !== null && cell.enemy.movableType === movableTypes.BANDIT) {
            cell.enemy.status = false;
            InteractionLogic.findMovableAndDelete(this, cell.enemy);
        }
    }
